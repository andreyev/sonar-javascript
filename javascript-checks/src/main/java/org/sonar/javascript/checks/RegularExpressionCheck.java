...
@Rule(key = "RegularExpression")
@RuleTemplate
public class RegularExpressionCheck extends SubscriptionVisitorCheck {

  private static final String DEFAULT_MESSAGE = "The regular expression matches this .";
  ...
  public void visitNode(Tree tree) {
    ...
    if (pattern != null) {
      ...
      for (SyntaxTrivia trivia : token.trivias()) {
        if (pattern.matcher(trivia.getCodeBody()).matches()) {
